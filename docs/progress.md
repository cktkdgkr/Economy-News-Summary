...
| M2. 계획·아키텍처 수립 | planner | IN_PROGRESS | 외부 의존성 확정으로 plan.md/architecture.md 재작성 필요(T-04 뉴스 수집을 NewsData.io 기준으로, T-07 스케줄러를 Firebase 기준으로). Q5/Q6/Q7/Q10/Q11 planner 결정 항목 클로즈. |
| M3. 사용자 승인 | (오케스트레이터 ↔ 사용자) | IN_PROGRESS | 외부 의존성 결정 완료(2026-05-22). planner 재작성 결과 검토 후 최종 승인. |
